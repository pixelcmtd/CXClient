...
import de.chrissx.api.Addon;
import de.chrissx.api.CommandExecutor;
...
//				addAddon(addon);
	 ...
	 * @throws IOException
	 */
	private AddonProperties loadProperties(File f) throws ZipException, IOException {
