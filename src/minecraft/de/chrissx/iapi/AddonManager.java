...
public class AddonManager {
	...
	public AddonManager(String addonPath) {
		...
		commands.add(new Command("cmdblock", new Consumer<String[]>() {
			@Override
		...
		commands.add(new Command("print-players", new Consumer<String[]>() {
			@Override
			public void accept(String[] args) {
		...
		commands.add(new Command("bind", new Consumer<String[]>() {
			@Override
			public void accept(String[] args) {
				if (args.length != 3) {
		...
		commands.add(new Command("mods", new Consumer<String[]>() {
			@Override
			public void accept(String[] args) {
				Iterator<Entry<String, Bindable>> it = hc.getMods().getBindEntrys().iterator();
		...
		commands.add(new Command("unbind", new Consumer<String[]>() {
			@Override
			public void accept(String[] args) {
				if (args.length < 2)
		...
		commands.add(new Command("say", new Consumer<String[]>() {
			@Override
			public void accept(String[] args) {
				if (args.length == 1) {
		...
		commands.add(new Command("binds", new Consumer<String[]>() {
			@Override
			public void accept(String[] args) {
		...
		commands.add(new Command("give", new Consumer<String[]>() {
			@Override
			public void accept(String[] args) {
				try {
		...
		commands.add(new Command("givebypass", new Consumer<String[]>() {
			@Override
			public void accept(String[] args) {
				try {
		...
		commands.add(new Command("debug", new Consumer<String[]>() {
			@Override
			public void accept(String[] args) {
		...
		commands.add(new Command("help", new Consumer<String[]>() {
			@Override
			public void accept(String[] args) {
