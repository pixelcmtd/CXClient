...
public class Regen extends Mod {
	...
	public void onTick()
	{
		...
		if(!playerController().isInCreativeMode() && p.getFoodStats().getFoodLevel() > 17 && p.getHealth() < 20 && p.getHealth() != 0 && p.onGround)
	...
	public void processCommand(String[] args)
	{
		...
		else Util.sendMessage("#regen to toggle, #regen speed <int> to set packets per tick (default is 100)");
	}
