...
public class GuiAchievements extends GuiScreen implements IProgressMeter
{
    ...
    {
        int i = MathHelper.floor(this.field_146569_s + (this.field_146567_u - this.field_146569_s) * (double)p_146552_3_);
        int j = MathHelper.floor(this.field_146568_t + (this.field_146566_v - this.field_146568_t) * (double)p_146552_3_);
