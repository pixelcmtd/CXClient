...
public class PlayerControllerMP
{
    ...
    {
    	return HackedClient.getClient().getMods().reach.isEnabled() ? HackedClient.getClient().getMods().reach.getReach() : currentGameType.isCreative() ? 5.0F : 4.5F;
    }
    ...
    {
        return this.currentGameType.isCreative() || HackedClient.getClient().getMods().reach.isEnabled();
    }
