...
public class ItemRenderer
{
    ...
    private void renderItemMap(AbstractClientPlayer clientPlayer, float p_178097_2_, float p_178097_3_, float p_178097_4_)
    {
        ...
        float f5 = MathHelper.sin(MathHelper.sqrt(p_178097_4_) * (float)Math.PI);
    ...
    {
        float f = -0.3F * MathHelper.sin(MathHelper.sqrt(p_178095_3_) * (float)Math.PI);
        float f1 = 0.4F * MathHelper.sin(MathHelper.sqrt(p_178095_3_) * (float)Math.PI * 2.0F);
        ...
        float f4 = MathHelper.sin(MathHelper.sqrt(p_178095_3_) * (float)Math.PI);
