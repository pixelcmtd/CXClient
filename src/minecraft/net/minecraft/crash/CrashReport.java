...
public class CrashReport
{
    ...
    public String getCauseStackTraceOrString()
    {
        ...
        if (t.getMessage() == null)
        {
            if (t instanceof NullPointerException)
                t = new NullPointerException(this.description);
            else if (t instanceof StackOverflowError)
                t = new StackOverflowError(this.description);
            else if (t instanceof OutOfMemoryError)
                t = new OutOfMemoryError(this.description);

            t.setStackTrace(this.cause.getStackTrace());
        }
    ...
    {
        String[] comments = new String[] {"I blame chrissx.", "You should probably report unexpected crashes to chrissx.", "TNT should solve this..."};
        ...
        {
            return "Well...can't get that message :(";
        }
    }
