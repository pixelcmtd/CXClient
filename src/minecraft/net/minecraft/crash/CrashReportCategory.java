...
public class CrashReportCategory
{
    ...
    public static String getCoordinateInfo(BlockPos pos)
    {
        ...
        try
        {
            sb.append(String.format("World: (%d,%d,%d)", new Object[] {i, j, k}));
        }
        ...
        try
        {
            ...
            int k2 = (l + 1 << 4) - 1;
            int l2 = (i1 + 1 << 4) - 1;
            sb.append(String.format("Chunk: (at %d,%d,%d in %d,%d; contains blocks %d,0,%d to %d,255,%d)", new Object[] {j1, k1, l1, l, i1, i2, j2, k2, l2}));
        }
        ...
        try
        {
            ...
            int j5 = (j3 + 1 << 9) - 1;
            int i3 = (k3 + 1 << 9) - 1;
            sb.append(String.format("Region: (%d,%d; contains chunks %d,%d to %d,%d, blocks %d,0,%d to %d,255,%d)", new Object[] {j3, k3, l3, i4, j4, k4, l4, i5, j5, i3}));
        }
