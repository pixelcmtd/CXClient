...
public abstract class Entity implements ICommandSender
{
    ...
    public void addEntityCrashInfo(CrashReportCategory category)
    {
        ...
        category.addCrashSection("Entity\'s Block location", CrashReportCategory.getCoordinateInfo((double)MathHelper.floor(this.posX), (double)MathHelper.floor(this.posY), (double)MathHelper.floor(this.posZ)));
