...
public class EntityAIControlledByPlayer extends EntityAIBase
{
    ...
    public void updateTask()
    {
        ...
        {
            f2 = this.thisEntity.worldObj.getBlockState(new BlockPos(MathHelper.floor((float)i), MathHelper.floor((float)j) - 1, MathHelper.floor((float)k))).getBlock().slipperiness * 0.91F;
        }
        ...
        int l = MathHelper.floor(this.thisEntity.posX + (double)f9);
        int i1 = MathHelper.floor(this.thisEntity.posZ + (double)f10);
