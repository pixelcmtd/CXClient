...
public class WalkNodeProcessor extends NodeProcessor
{
    ...
    public PathPoint getPathPointTo(Entity entityIn)
    {
        ...
        if (this.canSwim && entityIn.isInWater())
        {
            ...
            {
                ++i;
                blockpos$mutableblockpos.func_181079_c(MathHelper.floor(entityIn.posX), i, MathHelper.floor(entityIn.posZ));
            }
    ...
    {
        return this.openPoint(MathHelper.floor(x - (double)(entityIn.width / 2.0F)), MathHelper.floor(y), MathHelper.floor(target - (double)(entityIn.width / 2.0F)));
    }
